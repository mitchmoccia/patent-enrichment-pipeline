    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <div>
        ...
        <p className="mt-2 flex gap-4">
          ...
          <Link
            href={`/app/matters/${matter.id}/prior-art`}
            className="text-sm text-teal-accent hover:underline"
          >
            Prior art
          </Link>
          <Link
            href={`/app/matters/${matter.id}/claims`}
            className="text-sm text-teal-accent hover:underline"
          >
            Claims
          </Link>
          <Link
            href={`/app/matters/${matter.id}/alternatives`}
            className="text-sm text-teal-accent hover:underline"
          >
            Alternatives
          </Link>
          <Link
            href={`/app/matters/${matter.id}/specification`}
            className="text-sm text-teal-accent hover:underline"
          >
            Specification
          </Link>
          ...
          <Link
            href={`/app/matters/${matter.id}/commercial`}
            className="text-sm text-teal-accent hover:underline"
          >
            Commercial
          </Link>
          <Link
            href={`/app/matters/${matter.id}/filing`}
            className="text-sm text-teal-accent hover:underline"
          >
            Filing
          </Link>
          ...
          <Link
            href={`/app/matters/${matter.id}/security`}
            className="text-sm text-teal-accent hover:underline"
          >
            Security
          </Link>
